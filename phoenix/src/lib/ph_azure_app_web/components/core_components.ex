defmodule PhAzureAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhAzureAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhAzureAppWeb.Gettext, "errors", msg, opts)
    end
  end
